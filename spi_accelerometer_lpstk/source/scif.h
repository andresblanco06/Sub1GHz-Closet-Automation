/** \mainpage Driver Overview
  ...
  * Studio tool:
  * - <b>Project name</b>:     SPI Accelerometer for LPSTK
  * - <b>Project file</b>:     E:/andre/Documents/git/Sub1GHz-Closet-Automation/spi_accelerometer_lpstk/spi_accelerometer_lpstk.scp
  * - <b>Code prefix</b>:      -
  ...
  * - <b>Created</b>:          2020-05-02 00:02:56.655
  ...
  * Demonstrates low-power sampling of an SPI accelerometer (ADXL362) on the LaunchPad SensorTag Kit
  * (LPSTK), with simple processing.
  * 
  ...
  * 
  * Tilt detection is communicated to the System CPU application, which enables an LED on the LPSTK when
  * tilt is detected for each axis.
  * 
  ...
  * Samples the ADXL362 accelerometer on the LPSTK board, and performs simple filtering and tilt
  * detection.
  * 
