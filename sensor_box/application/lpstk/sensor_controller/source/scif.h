/** \mainpage Driver Overview
  ...
  * - <b>Created</b>:          2020-05-02 21:49:55.100
  ...
  * 
  * 
  * \subsection section_task_desc_dgp30_gas_sensor DGP30 Gas Sensor
...
/// DGP30 Gas Sensor: Task ID
#define SCIF_DGP30_GAS_SENSOR_TASK_ID 2
...
/// DGP30 Gas Sensor: SGP30_I2C_ADDRESS
#define SCIF_DGP30_GAS_SENSOR_SGP30_I2C_ADDRESS 88
/// DGP30 Gas Sensor: init command
#define SCIF_DGP30_GAS_SENSOR_SGP30_IAQ_INIT 8195
/// DGP30 Gas Sensor: 
#define SCIF_DGP30_GAS_SENSOR_SGP30_IAQ_SET_ABSOLUTE_HUMIDITY 8289
/// DGP30 Gas Sensor: 
#define SCIF_DGP30_GAS_SENSOR_SGP30_MEASURE_IAQ 8200
/// DGP30 Gas Sensor: 
#define SCIF_DGP30_GAS_SENSOR_SGP30_STATE_HUMIDITY 1
/// DGP30 Gas Sensor: 
#define SCIF_DGP30_GAS_SENSOR_SGP30_STATE_INIT 0
/// DGP30 Gas Sensor: 
#define SCIF_DGP30_GAS_SENSOR_SGP30_STATE_MEASURE 16
/// DGP30 Gas Sensor: 
#define SCIF_DGP30_GAS_SENSOR_SGP30_STATE_READ 256
/// DGP30 Gas Sensor I/O mapping: I2C SCL
#define SCIF_DGP30_GAS_SENSOR_DIO_I2C_SCL 4
/// DGP30 Gas Sensor I/O mapping: I2C SDA
#define SCIF_DGP30_GAS_SENSOR_DIO_I2C_SDA 5
...
/// DGP30 Gas Sensor: Task input data structure
typedef struct {
    uint16_t absoluteHumidity; ///< absolute humidity
} SCIF_DGP30_GAS_SENSOR_INPUT_T;


/// DGP30 Gas Sensor: Task output data structure
typedef struct {
    uint16_t co2;  ///< value from the sensor
    uint16_t tvoc; ///< 
} SCIF_DGP30_GAS_SENSOR_OUTPUT_T;


/// DGP30 Gas Sensor: Task state structure
typedef struct {
    uint16_t i2cStatus;  ///< I2C master status
    uint16_t sgp30state; ///< 
} SCIF_DGP30_GAS_SENSOR_STATE_T;
...
typedef struct {
    ...
    struct {
        SCIF_DGP30_GAS_SENSOR_INPUT_T input;
        SCIF_DGP30_GAS_SENSOR_OUTPUT_T output;
        SCIF_DGP30_GAS_SENSOR_STATE_T state;
    } dgp30GasSensor;
} SCIF_TASK_DATA_T;
